...
enum class BirdPaletteStyle {
    ...
    BALLENA_AZUL, RANA_VERDE, MARIPOSA_MONARCA, FLAMENCO_ROSA, CABALLITO_TURQUESA,
    CANGREJO_CORAL, MURCIELAGO_NOCHE, PANDA_MONO, ABEJA_CONTRASTE, CAMALEON, PERICO, GALLO
}
