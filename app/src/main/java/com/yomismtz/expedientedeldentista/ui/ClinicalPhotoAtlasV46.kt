...
private val occlusionPhotoOptionsV46 = listOf(
    PhotoOptionV46("Dentición", "Referencia de dentición temporal", "Identifica la etapa de dentición antes de clasificar relaciones oclusales. Esta imagen NO documenta por sí sola el plano terminal de segundos molares temporales.", ClinicalPhotoV46(R.drawable.ref_deciduous_teeth, "Dentición temporal", "Fotografía clínica de dentición temporal usada como referencia anatómica general; no se presenta como ejemplo de un plano terminal específico.", "Wikimedia Commons · David Shankbone · CC BY-SA 3.0/GFDL")),
...
private val tmjPhotosV46 = listOf(
    ...
    ClinicalPhotoV46(R.drawable.ref_tmj_panorama, "Cóndilo y fosa en imagen radiográfica", "Imagen panorámica que muestra fosa articular y cóndilo; es una referencia anatómica radiográfica y no una prueba diagnóstica específica de TTM.", "Wikimedia Commons · ANUG · CC BY-SA 4.0 · File:TMJ panorama.jpg" )
)
