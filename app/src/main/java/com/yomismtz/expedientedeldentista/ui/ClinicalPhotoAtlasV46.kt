...
private val occlusionPhotoOptionsV46 = listOf(
    PhotoOptionV46("Plano terminal", "Recto", "Las superficies distales de los segundos molares temporales superior e inferior coinciden aproximadamente en un mismo plano vertical. El esquema ayuda a reconocer la referencia; la relación se confirma clínicamente en máxima intercuspidación.", ClinicalPhotoV46(R.drawable.diagram_terminal_flush, "Plano terminal · recto", "Esquema educativo original: las caras distales de los segundos molares temporales coinciden.", "Ilustración original de la app · uso educativo")),
    PhotoOptionV46("Plano terminal", "Escalón mesial", "La superficie distal del segundo molar temporal inferior queda por delante de la del superior. Debe registrarse la magnitud y correlacionarse con crecimiento y transición a la dentición permanente.", ClinicalPhotoV46(R.drawable.diagram_terminal_mesial, "Plano terminal · escalón mesial", "Esquema educativo original con el segundo molar temporal inferior en posición más mesial.", "Ilustración original de la app · uso educativo")),
    ...
    PhotoOptionV46("Mordida cruzada", "Posterior unilateral", "La relación transversal está invertida en un solo lado posterior. Registra el lado y observa si existe desplazamiento funcional durante el cierre.", ClinicalPhotoV46(R.drawable.diagram_crossbite_unilateral, "Mordida cruzada posterior unilateral", "Esquema oclusal educativo original: inversión transversal posterior limitada a una hemiarcada.", "Ilustración original de la app · uso educativo")),
    PhotoOptionV46("Mordida cruzada", "Posterior bilateral", "La relación transversal invertida está presente en ambos sectores posteriores. Debe integrarse con anchura de arcadas, crecimiento y exploración funcional.", ClinicalPhotoV46(R.drawable.diagram_crossbite_bilateral, "Mordida cruzada posterior bilateral", "Esquema oclusal educativo original: inversión transversal en ambos lados posteriores.", "Ilustración original de la app · uso educativo")),
    PhotoOptionV46("Espacios y alineación", "Diastema interincisivo superior", "Qué es: espacio entre los incisivos centrales superiores. Cómo se identifica clínicamente: observa separación visible entre 11 y 21 (o centrales temporales), confirma que no exista contacto proximal y mide el espacio en milímetros; registra etapa de dentición y frenillo sin atribuir causa sólo por el aspecto.", ClinicalPhotoV46(R.drawable.ref_diastema, "Diastema interincisivo superior", "Fotografía clínica de espacio entre incisivos centrales superiores.", "Wikimedia Commons · Ian Furst · CC BY-SA 4.0")),
    PhotoOptionV46("Espacios y alineación", "Trema / espacios interdentales", "Qué es: espacio interdental entre dientes distintos de los incisivos centrales superiores. Cómo se identifica clínicamente: inspecciona la arcada, localiza cada espacio fuera de 11–21, registra los dientes que lo delimitan, distribución y medida aproximada en milímetros.", ClinicalPhotoV46(R.drawable.diagram_trema, "Trema · espacios interdentales", "Esquema educativo original de espacios interdentales fuera de la línea media de los incisivos centrales superiores.", "Ilustración original de la app · uso educativo")),
...
private val eruptionOptionsV46 = listOf(
    PhotoOptionV46("Erupción", "Adecuada", "Qué es: erupción que sigue una secuencia y cronología compatibles con la etapa de desarrollo. Cómo se identifica clínicamente: registra dientes presentes y emergentes, compara lados homólogos, edad y secuencia; confirma que no existan asimetrías persistentes u obstáculos clínicos.", ClinicalPhotoV46(R.drawable.ref_mixed_dentition, "Erupción · referencia de secuencia", "Referencia visual general de dentición mixta; la opción puede seleccionarse clínicamente sin depender de la imagen.", "Wikimedia Commons · Roquex · CC0")),
    PhotoOptionV46("Erupción", "Adelantada", "Qué es: aparición de un diente antes de la cronología esperada para la etapa del paciente. Cómo se identifica clínicamente: documenta qué diente emergió y la edad exacta de aparición, compara con la secuencia del resto de la dentición y valora movilidad, tejidos y función.", ClinicalPhotoV46(R.drawable.ref_infant_teeth, "Erupción adelantada", "Referencia de dientes temporales visibles en lactante. La edad exacta de aparición define si corresponde a natal o neonatal.", "Wikimedia Commons · Chrisbwah · CC BY-SA 3.0")),
    PhotoOptionV46("Erupción adelantada", "Diente natal / neonatal", "Qué es: diente natal, presente al nacimiento; diente neonatal, erupcionado durante los primeros 30 días de vida. Cómo se identifica clínicamente: confirma el momento de aparición con la historia, localización y morfología; examina movilidad, interferencia con alimentación y posible lesión traumática, y determina con evaluación clínica/radiográfica si pertenece a la serie normal o es supernumerario.", ClinicalPhotoV46(R.drawable.ref_infant_teeth, "Dientes en lactante · referencia para natal/neonatal", "Imagen de referencia de incisivos temporales en lactante; no se etiqueta como natal o neonatal sin conocer el momento exacto de erupción.", "Wikimedia Commons · Chrisbwah · CC BY-SA 3.0")),
    PhotoOptionV46("Erupción", "Retardada", "Qué es: erupción que ocurre más tarde de lo esperado al considerar edad, desarrollo y secuencia. Cómo se identifica clínicamente: verifica ausencia del diente en boca, compara con el homólogo contralateral y dientes vecinos, revisa espacio disponible y antecedentes; complementa con imagen cuando esté indicada para valorar posición, desarrollo u obstáculos.", ClinicalPhotoV46(R.drawable.ref_impacted_panorama, "Erupción retardada · referencia radiográfica", "La panorámica sirve para estudiar desarrollo, posición y posibles obstáculos; no diagnostica retraso por sí sola.", "Wikimedia Commons · Coronation Dental Specialty Group · CC BY 3.0")),
    PhotoOptionV46("Erupción", "Ectópica", "Qué es: erupción en una trayectoria o posición diferente de la esperada. Cómo se identifica clínicamente: observa emergencia fuera de la línea normal de la arcada, desplazamiento vestibular/palatino/lingual o alteración de trayectoria; registra diente, dirección, espacio y relación con dientes vecinos, complementando con imagen cuando proceda.", ClinicalPhotoV46(R.drawable.ref_impacted_canine, "Erupción ectópica · trayectoria anómala", "Radiografía de canino con posición/trayectoria anómala usada como referencia visual de erupción ectópica.", "Wikimedia Commons · DRosenbach · CC BY-SA 3.0"))
)
