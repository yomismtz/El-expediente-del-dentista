...
private val occlusionPhotoOptionsV46 = listOf(
    ...
    PhotoOptionV46("Espacios y alineación", "Diastema interincisivo superior", "Espacio entre los incisivos centrales superiores. Registra su magnitud y etapa de dentición; la fotografía no determina por sí sola la etiología.", ClinicalPhotoV46(R.drawable.ref_diastema, "Diastema interincisivo superior", "Fotografía clínica de espacio entre incisivos centrales superiores.", "Wikimedia Commons · Ian Furst · CC BY-SA 4.0")),
    PhotoOptionV46("Espacios y alineación", "Trema / espacios interdentales", "Espacios entre dientes distintos de los incisivos centrales superiores. Registra qué dientes delimitan cada espacio, distribución y magnitud.", ClinicalPhotoV46(R.drawable.diagram_trema, "Trema · espacios interdentales", "Esquema educativo original de espacios interdentales fuera de la línea media de los incisivos centrales superiores.", "Ilustración original de la app · uso educativo")),
...
private val eruptionOptionsV46 = listOf(
    PhotoOptionV46("Erupción", "Adecuada", "Erupción compatible con la secuencia y etapa de desarrollo esperadas para el paciente. La cronología se interpreta junto con edad, simetría, formación radicular y contexto clínico.", ClinicalPhotoV46(R.drawable.ref_mixed_dentition, "Erupción · referencia de secuencia", "Referencia visual general de dentición mixta; la opción puede seleccionarse clínicamente sin depender de la imagen.", "Wikimedia Commons · Roquex · CC0")),
    PhotoOptionV46("Erupción", "Adelantada", "Aparición del diente antes del intervalo esperado para la etapa del paciente. Confirma edad exacta de aparición y distingue dientes natales y neonatales.", ClinicalPhotoV46(R.drawable.ref_infant_teeth, "Erupción adelantada", "Referencia de dientes temporales visibles en lactante. La edad exacta de aparición define si corresponde a natal o neonatal.", "Wikimedia Commons · Chrisbwah · CC BY-SA 3.0")),
    PhotoOptionV46("Erupción adelantada", "Diente natal / neonatal", "Natal: presente al nacimiento. Neonatal: erupciona durante los primeros 30 días de vida. Registra movilidad, alimentación, lesión traumática y confirma que se trate de un diente de la serie normal o supernumerario.", ClinicalPhotoV46(R.drawable.ref_infant_teeth, "Dientes en lactante · referencia para natal/neonatal", "Imagen de referencia de incisivos temporales en lactante; no se etiqueta como natal o neonatal sin conocer el momento exacto de erupción.", "Wikimedia Commons · Chrisbwah · CC BY-SA 3.0")),
    PhotoOptionV46("Erupción", "Retardada", "Ausencia de erupción cuando, considerando desarrollo, simetría y secuencia, existe retraso respecto al patrón esperado. Requiere valorar espacio, obstáculos, desarrollo radicular y antecedentes.", ClinicalPhotoV46(R.drawable.ref_impacted_panorama, "Erupción retardada · referencia radiográfica", "La panorámica sirve para estudiar desarrollo, posición y posibles obstáculos; no diagnostica retraso por sí sola.", "Wikimedia Commons · Coronation Dental Specialty Group · CC BY 3.0")),
    PhotoOptionV46("Erupción", "Ectópica", "El diente sigue una trayectoria o emerge en una posición diferente de la esperada. Documenta diente, dirección, espacio disponible y relación con estructuras vecinas.", ClinicalPhotoV46(R.drawable.ref_impacted_canine, "Erupción ectópica · trayectoria anómala", "Radiografía de canino con posición/trayectoria anómala usada como referencia visual de erupción ectópica.", "Wikimedia Commons · DRosenbach · CC BY-SA 3.0"))
)
