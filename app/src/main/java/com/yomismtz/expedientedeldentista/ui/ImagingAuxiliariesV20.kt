...
"Cefalométrica lateral" to listOf("Steiner · SNA: posición anteroposterior maxilar respecto a base craneal; SNB: posición mandibular; ANB: relación maxilomandibular; SN-GoGn: patrón vertical; 1-NA y 1-NB: posición/inclinación incisiva. Identificar S, N, A, B, Go y Gn; trazar planos y medir ángulos/distancias. Interpretar con normas apropiadas a edad/población y contexto clínico."),
