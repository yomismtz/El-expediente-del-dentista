...
private val historyCardsV44 = listOf(
    ...
    HistoryCardV44(HistorySectionV44.FAMILY, "Antecedentes heredo-familiares", "Familiares maternos/paternos y categorías de enfermedad."),
    ...
    HistoryCardV44(HistorySectionV44.ORTHO, "Antecedentes ortodónticos", "Tratamientos previos, aparatos, duración y motivo.")
)
...
fun HistoryHubV44Screen(lang: String, onVitals: () -> Unit, onBack: () -> Unit) {
    ...
    when (section) {
        ...
        HistorySectionV44.FAMILY -> { FamilyHistoryV37Screen(lang) { section = null }; return }
        ...
        HistorySectionV44.ORTHO -> { OrthodonticHistoryV33Screen(lang) { section = null }; return }
        null -> Unit
    }
