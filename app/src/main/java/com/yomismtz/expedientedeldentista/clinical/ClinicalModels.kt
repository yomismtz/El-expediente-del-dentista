...
enum class AppScreen {
    ...
    PULPAL, APICAL, TREATMENT, SESSIONS, ENDO, PROSTHETIC, SURGICAL, EMERGENCY, CLINICAL_PHOTO, PERIODONTAL_FOLLOWUP, IMPLANTOLOGY, DENTOMAXILLARY_ORTHOPEDICS, PEDIATRIC_DENTISTRY, CARIES_RISK,
